...
#include "opc/da/server/frl_opc_enum_connection_points.h"
#include "opc/da/server/frl_opc_connection_point.h"

namespace frl{ namespace opc{

ConnectionPointContainer::ConnectionPointContainer() : count(0)
{
}
	...
	/* [out] */ IConnectionPoint **ppCP )
{
	...
	BOOST_FOREACH( ConnectionPointElem& el, points )
	{
		...
		{
			HRESULT hresult = el->QueryInterface( IID_IConnectionPoint, (void**)ppCP );
			return hresult;
		}
	}
...
long ConnectionPointContainer::getConnectionCount()
{
	return count;
}
