...
namespace Channels
{
	namespace Modbus
	{
		Sirius2ML::Sirius2ML( ChannelWPtr parent
			...
			: Sirius2Base(parent, deviceId, deviceType, "Ñèðèóñ-2-ÌË", serialId, modbusId)
		{
			...
			// I
			{
				...
				request.startAdress = modbusId;
				request.func = 3;
				request.startAdress = 1286;
				request.byteCount = 12;
