...
namespace Channels
{
	namespace Modbus
	{
		Sirius2D::Sirius2D( ChannelWPtr parent
			...
			: Sirius2Base(parent, deviceId, deviceType, "Ñèðèóñ-2-Ä", serialId, modbusId)
		{
			...
			// analog
			{
				...
				request.tags.push_back( TagInfo(paramTags.I0x, 4, factorCurrent /* À */) );
				request.tags.push_back( TagInfo(paramTags.I0y, 4, factorCurrent /* À */) );
