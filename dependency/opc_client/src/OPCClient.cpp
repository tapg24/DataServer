...
{	
	...
	// iMalloc проверяем, инициализировался ли кто-нибудь ещё до этого вызова
	if (!iMalloc)
	{
...
{
	if ( (CString::StringLength(hostName) == 0) || (hostName.CompareNoCase("localhost") == 0) )
	{
